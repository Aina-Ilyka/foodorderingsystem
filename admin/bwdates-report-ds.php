...
<form name="bwdatesreport"  action="bwdates-reports-details.php" method="GET"> 
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            ...
                                            <input type="radio" name="requesttype" value="Food Served">Dine-In order
                                            <input type="radio" name="requesttype" value="Food Pickup">Pick-up Order
                                        </div>
                                    </div>

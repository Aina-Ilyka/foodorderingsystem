...
if (strlen($_SESSION['admin_id']==0)) {
  header('location:logout.php');
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "UPDATE kstaff SET ks_name='$fname', ks_password='$password', ks_email='$email', ks_phone='$mobilenumber', ks_ic='$icnum', ks_status='$status' WHERE ks_id='$sid'");
...
<body>
        ...
        <div class="row border-bottom">
            ...
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="kuser-detail.php">Staff Details</a>
                    </li>
    ...
    echo $msg;
                      ...
                      <?php
$sid=$_GET['userid'];
$ret=mysqli_query($con,"SELECT * FROM kstaff where ks_id=$sid
");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {
    $ks_password = $row['ks_password'];
    $masked_password = str_repeat('*', strlen($ks_password)); // Masking the password characters
?>
                            ...
                            <form id="submit" action="#" class="wizard-big" method="post" name="submit">
                                    <fieldset>
                                          <div class="form-group row"><label class="col-sm-2 col-form-label">Full Name:</label>
                                                <div class="col-sm-10"><input name='firstname' id="firstname" class="form-control white_bg" value="<?php  echo $row['ks_name'];?>">
     
       
   </div>
                                            </div>
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Username:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="lastname" readonly="true" value="<?php  echo $row['ks_username'];?>"></div>
                                            </div>
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Email:</label>
                                                <div class="col-sm-10">
                                                 <input type="email" class="form-control" name="email" value="<?php  echo $row['ks_email'];?>">
                                            </div>
                                            </div>
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Mobile Number:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="mobilenumber"  value="<?php  echo $row['ks_phone'];?>"></div>
                                            </div>
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">I/C Number:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="icnum" value="<?php  echo $row['ks_ic'];?>"></div>
                                            </div>
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Status:</label>
                                                <div class="col-sm-10"><select class="form-control" name="status" required="true">
                                                    <?php
                                                    $cid = $_GET['userid'];
                                                    $query = "SELECT ks_status FROM kstaff WHERE ks_id='$cid'";
                                                    $result = mysqli_query($con, $query);

                                                    if ($result && mysqli_num_rows($result) > 0) {
                                                        $row = mysqli_fetch_assoc($result);
                                                        $currentStatus = $row['ks_status'];

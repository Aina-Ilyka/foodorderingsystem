...
<?php include_once('includes/leftbar.php');?>
       ...
       <div class="row border-bottom">
                ...
                <?php
                    ...
                    $records = $con->query("SELECT * FROM tblorderaddresses WHERE paystatus='Successful' AND ordertype='Dine-In' AND OrderFinalStatus='Cooking Completed' AND DATE(OrderTime) = '$today' ORDER BY OrderTime ASC");
                    ...
                    $result = $con->query("SELECT * FROM tblorderaddresses WHERE paystatus='Successful' AND ordertype='Dine-In' AND OrderFinalStatus='Cooking Completed' AND DATE(OrderTime) = '$today' ORDER BY OrderTime ASC LIMIT $start,$rows_per_page ");
                                ...
                                <div class="ibox">
                                    <div class="ibox-content">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6" style="margin-top:1.3%">
                                                    ...
                                                    <?php } else { ?>
                                                        ...
                                                        <tr>
                                                            <td colspan="6" style="text-align: center;">
                                                                <input type="button" id="completedButton" class="pagination-btn complete-button" name="completedButton" value="Served" style="display: none;" onclick="completeOrder('<?php echo $oid; ?>')">
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
                                        ...
                                        <?php }} else {
                                                    ...
                                                    echo '
                                                    <script>
                                                        if(confirm("All orders for today have been served. Click OK to go to dashboard.")) {
                                                    ...
                                                    <div class="row justify-content-center">
                                                        <div class="col-md-6">
                                                            <div class="alert alert-info text-center">
                                                                <p><strong>All orders for today have been served.</strong></p>

...
<?php include_once('includes/leftbar.php');?>
       ...
       <div class="row border-bottom">
                ...
                <?php
                    ...
                    $records = $con->query("SELECT * FROM tblorderaddresses WHERE paystatus='Successful' AND ordertype='Pick-Up' AND OrderFinalStatus='Food is being Prepared' AND DATE(OrderTime) = '$date' AND (
                    ...
                    $result = $con->query("SELECT * FROM tblorderaddresses WHERE paystatus='Successful' AND ordertype='Pick-Up' AND OrderFinalStatus='Food is being Prepared' AND DATE(OrderTime) = '$date' AND (
                        ADDTIME(CURTIME(), '00:10:00') >= pickuptime
                        OR pickuptime <= CURTIME()
                                                ...
                                                <div class="col-6" style="margin-top:1.3%">
                                                    ...
                                                    <div class="row pagination-section">
                                                        ...
                                                        <div class="col-lg-12 text-right" style="margin-top:3%;"> <!-- Aligning content to the right -->
                                                            ...
                                                            ?>
                                                               <a href="viewpickup2.php?date=<?php echo $today; ?>&pickup=<?php echo $savedStatus; ?>&page-nr=1" class="next-button">First order</a>
                                                               <a href="viewpickup2.php?date=<?php echo $today; ?>&pickup=<?php echo $savedStatus; ?>&page-nr=<?php echo $nextPage; ?>" class="next-button">Next</a>
                                                            <?php } else { ?>
                                                                <a href="viewpickup2.php?date=<?php echo $today; ?>&pickup=<?php echo $savedStatus; ?>&page-nr=1" class="next-button">First order</a>
                                                            <?php } ?>
                                                        </div>
   ...
   function openDrinkPopup() {
    ...
    if (this.readyState == 4 && this.status == 200) {
        ...
        if (response.success) {
            ...
            window.location.href = "viewpickup2.php?date=<?php echo $today; ?>&pickup=<?php echo $savedStatus; ?>&page-nr=" + currentPageNumber;
        } else {

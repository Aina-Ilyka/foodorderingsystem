...
<?php include_once('includes/leftbar.php');?>
       ...
       <div class="row border-bottom">
                ...
                <?php
                    ...
                    $records = $con->query("SELECT * FROM tblorderaddresses WHERE paystatus='Successful' AND ordertype='Dine-In' AND OrderFinalStatus='Confirmed Order' AND DATE(OrderTime) = '$today' ORDER BY OrderTime ASC");
                    ...
                    $result = $con->query("SELECT * FROM tblorderaddresses WHERE paystatus='Successful' AND ordertype='Dine-In' AND OrderFinalStatus='Confirmed Order' AND DATE(OrderTime) = '$today' ORDER BY OrderTime ASC LIMIT $start,$rows_per_page ");

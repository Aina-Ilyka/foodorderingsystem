                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="ibox ">
                            <div class="ibox-title">
                                <?php
                                $query = mysqli_query($con, "Select * from tblorderaddresses where paystatus='Successful'");
                                $totalorder = mysqli_num_rows($query);
                                ?>
                                <a class="text-muted text-uppercase m-b-20" href="#" style="font-size: 20px">
                    ...
                    <div class="col-lg-4">
                        <div class="ibox ">
                            <div class="ibox-title">
                                <?php
                                $query = mysqli_query($con, "SELECT * FROM fstaff UNION SELECT * FROM kstaff");
                                $staffcount = mysqli_num_rows($query);
                                ?>
                                <a class="text-muted text-uppercase m-b-20" href="#" style="font-size: 20px">
                            ...
                            <div class="ibox-content">
                                <h1 class="no-margins"><?php echo $staffcount; ?></h1>

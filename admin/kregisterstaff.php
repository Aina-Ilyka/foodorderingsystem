...
if (strlen($_SESSION['admin_id']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if (strlen($_POST['password']) < 8) {
            ...
            $query_check_username = "SELECT ks_id FROM kstaff WHERE ks_username = ?";
            ...
            if (mysqli_stmt_execute($stmt_check_username)) {
                ...
                if (mysqli_stmt_num_rows($stmt_check_username) > 0) {
                    ...
                    $query_insert = "INSERT INTO kstaff (ks_name, ks_username, ks_password, ks_email, ks_phone, ks_ic, ks_status) VALUES (?, ?, ?, ?, ?, ?, ?)";
                    ...
                    if (mysqli_stmt_execute($stmt_insert)) {
                        ...
                        header('location:kuser-detail.php');
                        exit;
                    } else {

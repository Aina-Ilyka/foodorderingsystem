...
$query=mysqli_query($con,"select admin_id from admin where admin_id='$adminid' and   admin_password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update admin set admin_password='$newpassword' where admin_id='$adminid'");

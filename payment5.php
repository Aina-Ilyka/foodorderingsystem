          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto" >
              ...
              while ($row2 = mysqli_fetch_assoc($result2)) {
                    ?>
                        <p class="float-end" style='color: black'>at as <input style="border: none; background-color: transparent" type="text" name="pay_date" 
                        value=" <?php echo $row2['pay_date']?>">MYT
                </p><br>
              <div class="auth-form-light " style="background-color:white">
                ...
                <div class="auth-form-light text-left p-0" style="background-color:#b0093d">
                        ...
                        <p style="color: black;"><b>Status</b><br><?php echo $row2['pay_status']?><br></p>
                    <p style="color: black;"><b>Date/Time</b><br><?php echo $row2['pay_date']?><br></p>
                    <p style="color: black;"><b>Reference Number</b><br><input style="border: none;" name="pay_transid" value="<?php echo $_SESSION['dum_transid']; ?>"></p>
                    <?php
              }
              ?>
                <div class="auth-form-light text-left p-0" style="background-color:#b0093d">
                ...
                // Display the stored value
                   ...
                   <p style="color: black;"><b>Amount</b><br>MYR <input style="border: none" type="text" name="pay_amount" value= "<?php echo number_format((float)$row ['payamnt'], 2, '.', ''); ?>" ></p>
                          ...
                          <a class="btn btn-danger float-end" style="background-color: #b0093d" type="button" href="index.php">Make Another Purchase</a><br><br></center>
                    <?php
                    }
                    ?><br>
                  </form>                 

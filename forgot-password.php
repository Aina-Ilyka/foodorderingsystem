...
if(isset($_POST['submit']))
  {
    ...
    $email=$_POST['email'];
        ...
        $query=mysqli_query($con,"select cust_id from customer where  cust_username='$email'");
...
<!--Email Id-->
                        ...
                        <input class="brd-rd3" type="input" placeholder="Username" name="email" id="email" required="true">
                                                        </div>

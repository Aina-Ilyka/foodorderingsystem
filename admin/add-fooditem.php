  ...
  header('location:logout.php');
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!in_array($extension, $allowed_extensions)) {
            ...
            // Using prepared statement to avoid SQL syntax issues
            $query = mysqli_prepare($con, "INSERT INTO tblfood(CategoryName, ItemName, ItemPrice, ItemDes, ItemQty, Image) VALUES (?, ?, ?, ?, ?, ?)");
    
            // Bind parameters to the statement
            mysqli_stmt_bind_param($query, "ssssss", $fcat, $itemname, $price, $description, $quantity, $itempic);
...
<body>
    ...
    <div class="col-sm-10">
        <select name='foodcategory' id="foodcategory" class="form-control white_bg" required="true">
            ...
            ?>
                <option value="<?php echo $categoryRow['CategoryName']; ?>"><?php echo $categoryRow['CategoryName']; ?></option>
            <?php } ?>
        </select>
    </div>
</div>

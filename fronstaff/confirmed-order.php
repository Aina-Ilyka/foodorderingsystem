                    ...
                    <div class="ibox">
                        <div class="ibox-content">
                                    <div class="row filter-section">
                                        <div class="col-md-5">
                                            <p style="color: blue; font-size: 20px">Order list [Dine-in]</p>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <select name="status" required class="form-select">
                                                ...
                                                <option value="Food Served" <?= isset($_GET['status']) == true ? ($_GET['status'] == 'Food Served' ? 'selected':'') :'' ?>>Food served</option>
                                            </select>
                                        </div>
                                        <div class="col-md-4">
                                                <button type="submit" class="btn btn-primary">Filter</button>
                                                <a href="confirmed-order.php" class="btn btn-danger">Reset</a>
                                        </div>
                                        </div>
                                        </form>
                                </div>
                            ...
                            $query = "SELECT * FROM tblorderaddresses WHERE paystatus='Successful' AND ordertype='Dine-In' $condition ORDER BY OrderTime DESC";
